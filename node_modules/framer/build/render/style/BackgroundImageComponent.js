...
const InnerImage = ({ image, containerSize, nodeId, alt }) => {
    ...
    return (React.createElement("div", { ref: wrapperRef, style: { display: "contents", borderRadius: "inherit", pointerEvents: "none" } }, isStaticRendering ? (React.createElement("img", { src: source, alt: alt ?? image.alt, srcSet: srcSet, sizes: image.sizes, style: imageStyle, loading: image.loading })) : null));
};
