...
const RichTextContainer = forwardRef((props, ref) => {
...
function styleRichTextChildren(element, stylesPresetsClassNames, plainText) {
    ...
    if (isString(element.type) || isMotionComponent(element.type)) {
        const tag = dataPresetTag || element.type;
...
function isMotionComponent(elementType) {
    switch (elementType) {
        case motion.a:
        case motion.div:
        case motion.em:
...
/** @internal */
export const RichText = forwardRef(({ children, html, htmlFromDesign, ...props }, ref) => {
